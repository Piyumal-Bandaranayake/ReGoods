...
export default async function CheckoutPage({ params }) {
    ...
    return (
        ...
        <div className="h-screen fixed inset-0 z-40 overflow-hidden w-full bg-gray-50/50 font-inter">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col lg:flex-row gap-8 pt-24 pb-8">
                ...
                {/* SUMMARY SIDE (Fixed) */}
                <div className="hidden lg:flex w-[350px] shrink-0 h-full flex-col justify-center">
