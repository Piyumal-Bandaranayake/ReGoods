        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>
                <Link href="/" className="hover:text-blue-500 transition">Browse Items</Link>
              </li>
              <li>
                <Link href="/items/create" className="hover:text-blue-500 transition">Start Selling</Link>
              </li>
              <li>
                <Link href="/dashboard?tab=buying" className="hover:text-blue-500 transition">My Wishlist</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>
                <Link href="#" className="hover:text-blue-500 transition">Help Center</Link>
              </li>
              <li>
                <Link href="#" className="hover:text-blue-500 transition flex items-center gap-1">
                  <ShieldCheck className="w-4 h-4" /> Safety Guidelines
                </Link>
              </li>
              <li>
                <Link href="#" className="hover:text-blue-500 transition">Report a User</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                <Link href="#" className="hover:text-blue-500 transition">Cookie Policy</Link>
              </li>
            </ul>
          </div>
        </div>
